...
// 协议簇
const PROTOCOLS = 'http https ws wss ssh ftp gopher mailto mid cid news nntp prospero telnet rlogin tn3270 wais'.split(
  ' ',
);

// Top Level Domain
const TOP_LEVEL_DOMAINS = ('com net org edu gov int mil cn ' +
  // 国内域名
