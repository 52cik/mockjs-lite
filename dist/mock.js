...
// 协议簇
var PROTOCOLS = 'http https ws wss ssh ftp gopher mailto mid cid news nntp prospero telnet rlogin tn3270 wais'.split(' ');

// Top Level Domain
var TOP_LEVEL_DOMAINS = ('com net org edu gov int mil cn ' +
// 国内域名
...
function county(prefix) {
  var provinceItem = this.pick(DICT$2);
  var cityItem = this.pick(provinceItem.children);
  var countyItem = this.pick(cityItem.children) || { name: '-' };
